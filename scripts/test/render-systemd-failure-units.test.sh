...
check "renderer preserves OnFailure wiring and mode" 'grep -Fqx "OnFailure=brokkr-systemd-failure@%n.service" "$OUT_DIR/brokkr-maintenance-os.service" && [[ "$(stat -f %Lp "$OUT_DIR/brokkr-systemd-failure-sweep.service")" == 644 ]]'
